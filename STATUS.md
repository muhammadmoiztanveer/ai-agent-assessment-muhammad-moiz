...
**Current phase:** Phase 1 — Persistence (next)
**Overall progress:** Phase 0 of 11 complete (foundation ✅)
...
- [ ] `db/models.py` — Profile, Run, Query, Recommendation (4 tables)
- [ ] `db/repositories.py` — typed data-access functions
- [ ] Round-trip sanity test (create/read profile + run)
- [ ] Commit: `feat(db): models + repositories`
...
| R26 | Persistence: profiles/runs/queries/recommendations       | ☐      | `app/db/models.py`                  |
...
**Done:** 1 / 32 (+1 in progress) — feature rows flip as Phases 1–10 land.
...
| Type-check                  | `make typecheck`       | ✅ clean (18 files)|
| Tests                       | `make test`            | ✅ 2 passed       |
